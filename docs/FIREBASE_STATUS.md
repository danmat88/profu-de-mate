...
- `analyzeMathImage`: revizia publicată la 25 august 2026 este `ACTIVE` în `europe-west1`, cu 100% trafic, hash `ead2505b70554bae2317ed0b761bcb6f6ed3ecdc`, Node 22, 512 MiB, timeout 120 s, `maxInstances: 3`, concurență 10, App Check obligatoriu și principal comercial HMAC stabil.
...
- `profu-data-runtime` are `roles/eventarc.eventReceiver`; invocarea publică a webhook-ului trebuie limitată logic de Authorization + HMAC, iar celelalte callables rămân protejate de Auth + App Check.
