          ...
          <ScrollView bounces={false} overScrollMode="never" showsVerticalScrollIndicator={false} style={styles.sheetScroll} contentContainerStyle={styles.sheetContent}>
            {sent ? (
              <View accessibilityRole="alert" accessibilityLiveRegion="assertive" style={styles.sentState}>
                ...
                <Text style={styles.sentTitle}>Mulțumim!</Text>
                <Text style={styles.sentText}>Mesajul tău ne ajută să îmbunătățim explicațiile.</Text>
...
const styles = StyleSheet.create({
  ...
  sheet: { width: '100%', maxWidth: 640, maxHeight: '92%', alignSelf: 'center', borderTopLeftRadius: 30, borderTopRightRadius: 30, borderWidth: 3, borderBottomWidth: 0, borderColor: colors.ink, backgroundColor: colors.canvas, paddingHorizontal: 18, paddingTop: 9 },
